        ...
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
            <ul class="w3-ul w3-border w3-bordered">
                ...
                <li class="w3-hover-shadow">
                    <a href="{{ route('department.student',['department' => 'CSE']) }}" class="w3-text-black btn">Current Students</a>
                </li>
                @if(Storage::disk('materials')->has('Syllabus-CSE.pdf'))
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'Syllabus-CSE.pdf']) }}" target="_blank" class="w3-text-black btn">Syllabus</a>
                </li>
                @else
                <li class="w3-hover-shadow">
                ...
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'Routine-CSE.pdf']) }}" target="_blank" class="w3-text-black btn">Class Routine</a>
                </li>
                @else
                <li class="w3-hover-shadow">
                ...
                @endif
                <li class="w3-hover-shadow">
                    <a href="{{ route('exam.list', ['department' => 'CSE']) }}" target="_blank" class="w3-text-black btn">Semester Result</a>
                </li>
                @if(Storage::disk('materials')->has('CourseRegistration-CSE.pdf'))
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'CourseRegistration-CSE.pdf']) }}" target="_blank" class="w3-text-black btn">Course Registration</a>
                </li>
                @else
                <li class="w3-hover-shadow">
                ...
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'FormFillUp-CSE.pdf']) }}" target="_blank" class="w3-text-black btn">Exam FormFillUp</a>
                </li>
                @else
                <li class="w3-hover-shadow">
            ...
            <div id="about" class="panel panel-default w3-hover-shadow">
                ...
                <div class="panel-body w3-light-grey row"  style="height: 200px; overflow: auto; text-align: justify;">
                    <p class="w3-large" style="font-family: optima">
                        Department of Computer Science & Engineering (CSE) of 
                        Rajshahi University of Engineering & Technology (RUET) 
                        has an illustrious tradition of success dating from 1998. 
                        This success has been due to the collective vision, labor 
                        and caring of dedicated departmental administration, faculty, 
                        staff and students. CSE RUET provide 4 years B. Sc. Engineering 
                        in Computer Science & Engineering course 2 years M.Sc. 
                        and 3 years PhD Program to the local and foreign students. 
                        About 120 students get undergraduate bachelor's degrees 
                        from this department each year.
                    </p>
      ...
      <div class="modal-dialog">
          ...
          <div class="modal-content">
              <div class="modal-header w3-blue">
                ...
                <div>
                    <p class="h4"><span class="fa fa-address-card-o"></span>&emsp;Dept. of Computer Science and Engineering (CSE),<br>
                       ...
                       <span class="fa fa-internet-explorer"></span>&emsp;<a href="http://cse.ruet.ac.bd" target="_blank">http://cse.ruet.ac.bd</a>&emsp;&emsp;&emsp;
                       <span class="fa fa-envelope-o"></span>&emsp;<a href="https://mail.google.com/mail/u/0/#inbox?compose=new" target="_blank">cse@ruet.ac.bd</a>
                   </p>
               </div>
              <div class="modal-footer w3-light-grey">
                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
