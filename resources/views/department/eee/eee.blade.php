...
<div class="container">
    <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
            <ul class="w3-ul w3-border w3-bordered">
                ...
                <li class="w3-hover-shadow">
                    <a href="{{ route('department.student',['department' => 'EEE']) }}" class="w3-text-black btn">Current Students</a>
                </li>
                @if(Storage::disk('materials')->has('Syllabus-EEE.pdf'))
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'Syllabus-EEE.pdf']) }}" target="_blank" class="w3-text-black btn">Syllabus</a>
                </li>
                @else
                <li class="w3-hover-shadow">
                ...
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'Routine-EEE.pdf']) }}" target="_blank" class="w3-text-black btn">Class Routine</a>
                </li>
                @else
                <li class="w3-hover-shadow">
                ...
                @endif
                <li class="w3-hover-shadow">
                    <a href="{{ route('exam.list', ['department' => 'EEE']) }}" target="_blank" class="w3-text-black btn">Semester Result</a>
                </li>
                @if(Storage::disk('materials')->has('CourseRegistration-EEE.pdf'))
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'CourseRegistration-EEE.pdf']) }}" target="_blank" class="w3-text-black btn">Course Registration</a>
                </li>
                @else
                <li class="w3-hover-shadow">
                ...
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'FormFillUp-EEE.pdf']) }}" target="_blank" class="w3-text-black btn">Exam FormFillUp</a>
                </li>
                @else
                <li class="w3-hover-shadow">
        ...
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6 w3-right">
            <ul class="w3-ul w3-border w3-bordered">
                <li class="w3-indigo w3-xlarge w3-center">EEE RUET</li>
                <li class="w3-hover-shadow"><a href="#about" class="w3-text-black btn">About EEE RUET</a></li>
    ...
    <div class="row">
        <div class="col-md-7">
            <div id="about" class="panel panel-default w3-hover-shadow">
                <div class="panel-heading w3-blue row"><h3>About EEE RUET</h3></div>
                <div class="panel-body w3-light-grey row"  style="height: 200px; text-align: justify; overflow: auto;">
                    <p class="w3-large" style="font-family: optima">
                        Electrical and Electronic Engineering is a field of engineering 
                        that generally comprises of a number of subfields including 
                        electrical power engineering, electromagnetism, electronics, 
                        digital computers, telecommunications, electrical machinery 
                        and drive systems, control systems, RF engineering, signal 
                        processing, instrumentation, and microelectronics. Electrical 
                        and Electronics Engineers work in a very wide range of 
                        industries and the skills required are likewise variable. 
                        They may become members of professional societies like 
                        Institute of Electrical and Electronics Engineering (IEEE), 
                        USA, Institute of Engineering & Technology (IET), UK, and 
        ...
        <div class="col-md-4 col-md-offset-1">
            <div class="panel panel-default w3-hover-shadow">
                <div class="panel-heading w3-blue row"><h3>Head of EEE RUET</h3></div>
      ...
      <div class="modal-dialog">
          ...
          <div class="modal-content">
              <div class="modal-header w3-blue">
                ...
                <div>
                    <p class="h4"><span class="fa fa-address-card-o"></span>&emsp;Dept. of Electrical and Electronic Engineering (EEE),<br>
                       ...
                       <span class="fa fa-internet-explorer"></span>&emsp;<a href="http://eee.ruet.ac.bd/" target="_blank">http://eee.ruet.ac.bd/</a>&emsp;&emsp;&emsp;
                       <span class="fa fa-envelope-o"></span>&emsp;<a href="https://mail.google.com/mail/u/0/#inbox?compose=new" target="_blank">eee@ruet.ac.bd</a>
                   </p>
               </div>
              <div class="modal-footer w3-light-grey">
                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
