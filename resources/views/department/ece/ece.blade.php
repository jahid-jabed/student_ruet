...
<div class="container">
    <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
            <ul class="w3-ul w3-border w3-bordered">
                ...
                <li class="w3-hover-shadow">
                    <a href="{{ route('department.student',['department' => 'ECE']) }}" class="w3-text-black btn">Current Students</a>
                </li>
                @if(Storage::disk('materials')->has('Syllabus-ECE.pdf'))
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'Syllabus-ECE.pdf']) }}" target="_blank" class="w3-text-black btn">Syllabus</a>
                </li>
                @else
                <li class="w3-hover-shadow">
                ...
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'Routine-ECE.pdf']) }}" target="_blank" class="w3-text-black btn">Class Routine</a>
                </li>
                @else
                <li class="w3-hover-shadow">
                ...
                @endif
                <li class="w3-hover-shadow">
                    <a href="{{ route('exam.list', ['department' => 'ECE']) }}" target="_blank" class="w3-text-black btn">Semester Result</a>
                </li>
                @if(Storage::disk('materials')->has('CourseRegistration-ECE.pdf'))
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'CourseRegistration-ECE.pdf']) }}" target="_blank" class="w3-text-black btn">Course Registration</a>
                </li>
                @else
                <li class="w3-hover-shadow">
                ...
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'FormFillUp-ECE.pdf']) }}" target="_blank" class="w3-text-black btn">Exam FormFillUp</a>
                </li>
                @else
                <li class="w3-hover-shadow">
        ...
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6 w3-right">
            <ul class="w3-ul w3-border w3-bordered">
                <li class="w3-indigo w3-xlarge w3-center">ECE RUET</li>
                <li class="w3-hover-shadow"><a href="#about" class="w3-text-black btn">About ECE RUET</a></li>
    ...
    <div class="row">
        <div class="col-md-7">
            <div id="about" class="panel panel-default w3-hover-shadow">
                <div class="panel-heading w3-blue row"><h3>About ECE RUET</h3></div>
                <div class="panel-body w3-light-grey row"  style="height: 200px; text-align: justify; overflow: auto;">
                    <p class="w3-large" style="font-family: optima">
                        Rajshahi University of Engineering & Technology, one of 
                        the top engineering university in the country, has opened 
                        the department of Electrical and Computer Engineering (ECE) 
                        in 2016. The department has the mission of accumulation, 
                        generation and propagation of knowledge in the field of 
                        Electrical and Computer Engineering. The central aim to 
                        the mission is a top quality educational program and research 
                        that benefits our students, researcher, the division of Rajshahi, 
                        the national and the world. The department also focuses and 
                        acts for enlargement, growth and entrepreneurship. It is 
                        expected that the department will assist future growth 
                        in areas of fundamental economic importance to the country.
                    </p>
        ...
        <div class="col-md-4 col-md-offset-1">
            <div class="panel panel-default w3-hover-shadow">
                <div class="panel-heading w3-blue row"><h3>Head of ECE RUET</h3></div>
      ...
      <div class="modal-dialog">
          ...
          <div class="modal-content">
              <div class="modal-header w3-blue">
                ...
                <div>
                    <p class="h4"><span class="fa fa-address-card-o"></span>&emsp;Dept. of Electrical and Computer Engineering (ECE),<br>
                       ...
                       <span class="fa fa-internet-explorer"></span>&emsp;<a href="http://ece.ruet.ac.bd/" target="_blank">http://ece.ruet.ac.bd/</a>&emsp;&emsp;&emsp;
                       <span class="fa fa-envelope-o"></span>&emsp;<a href="https://mail.google.com/mail/u/0/#inbox?compose=new" target="_blank">ece@ruet.ac.bd</a>
                   </p>
               </div>
              <div class="modal-footer w3-light-grey">
                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
