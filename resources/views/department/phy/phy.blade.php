...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6 w3-right">
            <ul class="w3-ul w3-border w3-bordered">
                <li class="w3-indigo w3-xlarge w3-center">PHY RUET</li>
                <li class="w3-hover-shadow"><a href="#about" class="w3-text-black btn">About PHY RUET</a></li>
    ...
    <div class="row">
        <div class="col-md-7">
            <div id="about" class="panel panel-default w3-hover-shadow">
                <div class="panel-heading w3-blue row"><h3>About PHY RUET</h3></div>
                <div class="panel-body w3-light-grey row"  style="height: 200px; overflow: auto; text-align: justify;">
                    <p class="w3-large" style="font-family: optima">
                        Welcome to the department of physics, Rajshahi University 
                        of Engineering & Technology (RUET), Rajshahi-6204, Bangladesh. 
                        Currently the department is functioning under the umbrella 
                        of the faculty of the applied science and engineering, RUET.
                    </p>
                    <p class="w3-large" style="font-family: optima">
                        Physics deals with the study of matter and energy as well 
                        as the interactions among them. Physics itself is the most 
                        elementary science that employ rigorous logic, mathematics, 
                        statistics, experimentation, and critical thinking.
                        <a data-toggle="modal" href="#about_phy" class="btn btn-primary w3-right">Read more</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-4 col-md-offset-1">
            <div class="panel panel-default w3-hover-shadow">
                <div class="panel-heading w3-blue row"><h3>Head of PHY RUET</h3></div>
...
<div class="modal w3-animate-zoom" id="online_course" role="dialog">
      ...
      <div class="modal-dialog">
          ...
          <div class="modal-content">
              <div class="modal-header w3-blue">
                ...
                <div>
                    <p class="h4"><span class="fa fa-address-card-o"></span>&emsp;Dept. of Physics (PHY),<br>
                       &emsp;&emsp;Rajshahi University of Engineering & Technology (RUET),<br>
                       &emsp;&emsp;Kazla, Rajshahi-6204, Bangladesh.<br><br>
                       <span class="fa fa-fax"></span>&emsp;+88 (0721) 750105&emsp;&emsp;&emsp;
                       <span class="fa fa-phone"></span>&emsp;+88 (721) 750742-3, 751320-1<br><br>
                       <span class="fa fa-internet-explorer"></span>&emsp;<a href="http://phy.ruet.ac.bd" target="_blank">http://phy.ruet.ac.bd</a>&emsp;&emsp;&emsp;
                       <span class="fa fa-envelope-o"></span>&emsp;<a href="https://mail.google.com/mail/u/0/#inbox?compose=new" target="_blank">phy@ruet.ac.bd</a>
                   </p>
               </div>
              <div class="modal-footer w3-light-grey">
                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
 ...
 <div class="modal w3-animate-zoom" id="about_phy" role="dialog">
      <div class="modal-dialog">
          ...
          <div class="modal-content">
              <div class="modal-header w3-blue">
                  <button type="button" class="close w3-xlarge w3-btn-floating" data-dismiss="modal">&times;</button>
                  <h4 class="modal-title w3-xlarge w3-center">About PHY RUET</h4>
              </div>
              <div class="modal-body w3-large" style="text-align: justify;">
                  ...
                  <p style="font-family: optima">
                      Physics deals with the study of matter and energy as well as 
                      the interactions among them. Physics itself is the most elementary 
                      science that employ rigorous logic, mathematics, statistics, 
                      experimentation, and critical thinking.
                  </p>
                  
                  <p style="font-family: optima">
                      The department of physics, RUET started its journey from 
                      5th January, 1965. We are proud that the first theory class 
                      of this University (The then Rajshahi Engineering College) 
                      was started with a physics course conducted by Mr. Munshi Md. Ajijul Haque. 
                      Since then our journey begun to search for new knowledge or innovations. 
                      That paved the way for achieving the goal of RUET. 
                      We offer a wide range of physics courses to the undergraduate levels. 
                      Moreover in the year 2011 the department introduced the postgraduate 
                      program (M.Phil. and Ph.D.). This progran has been designed with 
                      both up to date courses and state of the art research facilities 
                      to maintain international standard with a view to opening 
                      opportunities for the students who desire to acquire higher 
                      degrees for building up their successful careers in the field 
                      of physics or relevant areas. Our postgraduate research program 
                      in physics is organized around two main areas: the computational 
                      and experimental physics. Interested potential students are 
                      advised to get admission to these programmes.
                  </p>
              </div>
              <div class="modal-footer w3-light-grey">
                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
