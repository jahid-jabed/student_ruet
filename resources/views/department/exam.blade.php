                ...
                <table class="w3-table w3-striped w3-border w3-bordered w3-card-4 w3-accordion w3-large" id="myTable">
                  ...
                  @foreach($exams as $exam)
                    <tr>
                        ...
                        <td>{{ $exam->year }}</td>
                        <td>{{ $exam->semester }}</td>
                        <td>{{ $exam->examination }}<a href="{{ route('result.sheet', ['year' => $exam->year, 'semester' => $exam->semester, 'examination' => $exam->examination, 'department' => $department]) }}" target="_blank" class="w3-right btn btn-primary">Result&emsp;<span class="fa fa-file-text-o"</a></td>
                    </tr>
                    <?php $count = $count + 1;?>
                  @endforeach
                  </tbody>
