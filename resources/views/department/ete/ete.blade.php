...
<div class="container">
    <div class="row">
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6">
            <ul class="w3-ul w3-border w3-bordered">
                ...
                <li class="w3-hover-shadow">
                    <a href="{{ route('department.student',['department' => 'ETE']) }}" class="w3-text-black btn">Current Students</a>
                </li>
                @if(Storage::disk('materials')->has('Syllabus-ETE.pdf'))
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'Syllabus-ETE.pdf']) }}" target="_blank" class="w3-text-black btn">Syllabus</a>
                </li>
                @else
                <li class="w3-hover-shadow">
                ...
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'Routine-ETE.pdf']) }}" target="_blank" class="w3-text-black btn">Class Routine</a>
                </li>
                @else
                <li class="w3-hover-shadow">
                ...
                @endif
                <li class="w3-hover-shadow">
                    <a href="{{ route('exam.list', ['department' => 'ETE']) }}" target="_blank" class="w3-text-black btn">Semester Result</a>
                </li>
                @if(Storage::disk('materials')->has('CourseRegistration-ETE.pdf'))
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'CourseRegistration-ETE.pdf']) }}" target="_blank" class="w3-text-black btn">Course Registration</a>
                </li>
                @else
                <li class="w3-hover-shadow">
                ...
                <li class="w3-hover-shadow">
                    <a href="{{ route('get.materials', ['filename' => 'FormFillUp-ETE.pdf']) }}" target="_blank" class="w3-text-black btn">Exam FormFillUp</a>
                </li>
                @else
                <li class="w3-hover-shadow">
        ...
        <div class="col-lg-2 col-md-2 col-sm-6 col-xs-6 w3-right">
            <ul class="w3-ul w3-border w3-bordered">
                <li class="w3-indigo w3-xlarge w3-center">ETE RUET</li>
                <li class="w3-hover-shadow"><a href="#about" class="w3-text-black btn">About ETE RUET</a></li>
    ...
    <div class="row">
        <div class="col-md-7">
            <div id="about" class="panel panel-default w3-hover-shadow">
                <div class="panel-heading w3-blue row"><h3>About ETE RUET</h3></div>
                <div class="panel-body w3-light-grey row"  style="height: 200px; text-align: justify; overflow: auto;">
                    <p class="w3-large" style="font-family: optima">
                        Electronics and Telecommunication Engineering is an engineering 
                        discipline that brings together electrical engineering with 
                        computer science to enhance telecommunication systems. 
                        ...
                        overseeing the installation of telecommunications equipment 
                        and facilities, such as complex electronic switching systems, 
                        copper wire telephone facilities, and fiber optics. 
                        Telecommunication engineering also overlaps heavily with broadcast engineering.
                    </p>
        ...
        <div class="col-md-4 col-md-offset-1">
            <div class="panel panel-default w3-hover-shadow">
                <div class="panel-heading w3-blue row"><h3>Head of ETE RUET</h3></div>
      ...
      <div class="modal-dialog">
          ...
          <div class="modal-content">
              <div class="modal-header w3-blue">
                ...
                <div>
                    <p class="h4"><span class="fa fa-address-card-o"></span>&emsp;Dept. of Electronics and Telecommunication Engineering (ETE),<br>
                       ...
                       <span class="fa fa-internet-explorer"></span>&emsp;<a href="http://ete.ruet.ac.bd/" target="_blank">http://ete.ruet.ac.bd/</a>&emsp;&emsp;&emsp;
                       <span class="fa fa-envelope-o"></span>&emsp;<a href="https://mail.google.com/mail/u/0/#inbox?compose=new" target="_blank">ete@ruet.ac.bd</a>
                   </p>
               </div>
              <div class="modal-footer w3-light-grey">
                  <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
