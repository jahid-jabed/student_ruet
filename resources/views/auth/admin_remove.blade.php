                ...
                <div>
                    <table class="w3-table w3-striped w3-bordered w3-card-4 w3-accordion">
                        <tr>
                          ...
                          <td>
                              <input class="w3-input w3-border w3-padding" type="text" placeholder="Search by department..." id="DeptInput" onkeyup="DeptFunction()">
                          </td>
                          <td>
                ...
                <table class="w3-table w3-striped w3-border w3-bordered w3-card-4 w3-accordion w3-large" id="myTable">
                  ...
                  @if($user->department != 'default')
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('remove.now.one', ['roll' => $user->user_id]) }}" class="btn btn-danger w3-center">Remove&nbsp;<i class="fa fa-minus-square-o"></i></a>
                        </td>
                    </tr>
                    <?php $count = $count + 1;?>
                    @endif
