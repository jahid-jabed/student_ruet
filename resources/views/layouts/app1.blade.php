...
<!--                                        @else
                                            <a href="{{ route(Auth::user()->department.'.dashboard') }}" class="w3-indigo w3-small">
                                                <span class="fa fa-globe"></span>&emsp;Dashboard
                                            </a>
                                        @endif-->
                                    </li>
                        ...
                        <li>
                            <table class="w3-table w3-border">
                                <tr>
                                    <td class="w3-center">
                                        <a href="#small-menu" style="text-decoration:none;" class="w3-text-white retroshadow">@yield('title')</a>
                                    </td>
                                </tr>
                            </table>
                        </li>
...
<!--                            @else
                                <a href="{{ route(Auth::user()->department.'.dashboard') }}"><i class="fa fa-globe"></i></a>
                            @endif-->
                        </li>
                        @endif
                        @if (Auth::user()->admin == 0)
