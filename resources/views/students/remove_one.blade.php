                ...
                <table class="w3-table w3-striped w3-border w3-bordered w3-card-4 w3-accordion w3-large" id="myTable">
                  ...
                  @foreach($students as $user)
                    <tr>
                        ...
                        <td>{{ $user->name }}</td>
                        <td>
                            <a href="{{ route('new.mail', ['roll' => $user->roll]) }}" target="_blank">{{ $user->email }}</a>
                        </td>
                        <td>
                            <a href="{{ route('remove.now.one', ['roll' => $user->roll]) }}" class="btn btn-danger w3-center">Remove&emsp;<i class="fa fa-ban"></i></a>
                        </td>
                    </tr>
                    <?php $count = $count + 1;?>
                  @endforeach
